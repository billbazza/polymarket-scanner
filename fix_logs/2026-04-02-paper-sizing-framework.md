...
- Followed repo contract from [AGENTS.md](/Users/will/.cline/worktrees/e61dc/polymarket-scanner/AGENTS.md), especially Architecture, Never Do, Always Do, and Testing Changes.
...
## Fixes Applied
- Added [paper_sizing.py](/Users/will/.cline/worktrees/e61dc/polymarket-scanner/paper_sizing.py) as a paper-only sizing framework with:
...
- Added migration `013_paper_sizing_decisions` plus decision/query helpers in [db.py](/Users/will/.cline/worktrees/e61dc/polymarket-scanner/db.py) so recent sizing recommendations and summaries are persisted and reviewable.
- Updated [autonomy.py](/Users/will/.cline/worktrees/e61dc/polymarket-scanner/autonomy.py) so paper pairs and weather trades record sizing decisions only after the normal admission path has already succeeded, while execution remains on the selected paper policy.
- Updated [server.py](/Users/will/.cline/worktrees/e61dc/polymarket-scanner/server.py) with `GET /api/paper-sizing` and extended stats to surface sizing observability.
- Added the dated rollout note [reviews/2026-04-02-paper-sizing-rollout-review.md](/Users/will/.cline/worktrees/e61dc/polymarket-scanner/reviews/2026-04-02-paper-sizing-rollout-review.md) to document the recommendation before any broader rollout.
- Added focused regression coverage in [tests/test_paper_sizing.py](/Users/will/.cline/worktrees/e61dc/polymarket-scanner/tests/test_paper_sizing.py) for:
...
- `python3 -m unittest tests.test_paper_sizing tests.test_strategy_performance`
